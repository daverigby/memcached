...
namespace BinaryProtocolValidator {
    ...
    protected:
        int validate() {
            return ValidatorTest::validate(PROTOCOL_BINARY_CMD_DCP_SET_VBUCKET_STATE,
                                           static_cast<void*>(&request));
        }
    ...
    protected:
        int validate() {
            return ValidatorTest::validate(PROTOCOL_BINARY_CMD_DCP_BUFFER_ACKNOWLEDGEMENT,
                                           static_cast<void*>(&request));
        }
    ...
    protected:
        int validate() {
            return ValidatorTest::validate(PROTOCOL_BINARY_CMD_SET_DRIFT_COUNTER_STATE,
                                           static_cast<void*>(&request));
        }
        protocol_binary_request_set_drift_counter_state request;
    };
