...
``std::exception``. This gives a consistent interface to obtain the
description (``what()``), and provides a common base-class for all
exceptions used. All exceptions generated by the standard library
